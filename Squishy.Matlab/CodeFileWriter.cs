...
namespace WCell.Util.Code
{
	public class CodeFileWriter : IDisposable
	{
		...
		public void NewComma(string type)
		{
			WriteLine("new " + type + "(),");
		}

		public void NewComma(string type, IEnumerable<string> args)
		{
            WriteLine("new " + type + "(" + string.Join(", ", args) + "),");
		}
		...
		public void OnException(Exception ex)
		{
			if (!raisedException)
			{
				...
				try
				{
					...
					Console.WriteLine("Failed to write code-file \"{0}\" - Reverting...", m_fileName);
					Revert();
				}
				catch (Exception ex2)
				{
